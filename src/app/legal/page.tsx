...
Leiga er eingöngu í boði til langtíma (mánuður eða lengur). Leigutaki ber ábyrgð á búnaðinum á meðan hann er í hans vörslu, þar á meðal vegna skemmda, taps eða þjófnaðar.</p>
			...
			<p className="text-black/70 dark:text-white/70">5. Trygging og ábyrgð</p>
...
Leigusali áskilur sér rétt til að loka aðgangi að búnaði eða endurkalla hann ef grunur vaknar um misnotkun eða brot á þessum skilmálum.</p>
			<p className="text-black/70 dark:text-white/70">8. Viðhald og tækniaðstoð</p>
			...
			<p className="text-black/70 dark:text-white/70">9. Skil á búnaði</p>
			...
			<p className="text-black/70 dark:text-white/70">10. Persónuvernd og gagnavarsla</p>
