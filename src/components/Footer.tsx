			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 grid gap-6 sm:grid-cols-2 items-center">
				...
				<nav aria-label="Footer" className="justify-self-start sm:justify-self-end flex gap-4 text-sm items-center">
					...
					<a 
						...
						className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
